import twstock
stock = twstock.Stock('2330')  # 以鴻海的股票代號建立 Stock 物件


###### 利用 fetch, fetch_31, fetch_from 指令抓取不同日期的股價
stock.fetch(2024,5) # 取得 2020 年 1 月的資料
...
###### 股票即時(最近一筆)交易資訊
real = twstock.realtime.get('2330') # 鴻海股票即時交易資訊.  'best_bid_price': 下五檔. 'best_ask_price': 上五檔.
# type(real)  ## dict
